...
@Slf4j
//@Service
public class Manchu11DictQueryTaskSender implements BaseSender {
    @Autowired
    ...
    public void send() {
        ...
        for (String keyWord : keyMaps.keySet()) {
            ...
            while (ite.hasNext()) {
                ...
                taskQueueService.sendTask(CrawlerUtils.getTaskQueueName(Manchu11DictQueryTask.class), new CrawlerMessage(TohokuConstants.TOHOKU_MANCHU_URL, paramMap), TohokuConstants.MAX_TASK_LENGTH);
