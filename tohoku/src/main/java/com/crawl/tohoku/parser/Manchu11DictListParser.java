...
@Slf4j
@Service
public class Manchu11DictListParser extends DictContentListParser implements ListPageParser<TransWordInfo> {

    @Override
    protected String parseTransWord(Element rowItem) {
        return PhraseTranslateUtils.formatBlankInfo(rowItem.select("td:eq(2)").text());
    }
